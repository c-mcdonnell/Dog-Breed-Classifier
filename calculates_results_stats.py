...
def calculates_results_stats(results_dic):
    ...
    for entry in results_dic:
        ...
        n_dogs_img += results_dic[entry][3]
        n_match += results_dic[entry][2]
        if results_dic[entry][3] == 1 and results_dic[entry][4] == 1:
            n_correct_dogs +=1
        if results_dic[entry][3] == 0 and results_dic[entry][4] == 0:
            n_correct_notdogs +=1
        if results_dic[entry][3] == 1:
            dog_breeds.append(results_dic[entry][0])
        if results_dic[entry][2] == 0 and results_dic[entry][3] == 1 and results_dic[entry][4] == 1:
            breed_match += 1
    n_notdogs_img = n_images-n_dogs_img
    n_correct_breed = n_dogs_img - breed_match
